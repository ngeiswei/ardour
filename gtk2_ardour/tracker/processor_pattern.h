...
#ifndef __ardour_tracker_processor_pattern_h_
 ...
 * (plugin and such).
 */
class ProcessorPattern : public AutomationPattern {
public:
	ProcessorPattern (TrackerEditor& te,
	                  RegionPtr region,
	                  bool connect,
	...
	ProcessorPatternPhenomenalDiff phenomenal_diff (const ProcessorPattern& prev) const;
