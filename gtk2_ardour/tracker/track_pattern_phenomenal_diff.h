...
struct TrackPatternPhenomenalDiff : public BasePatternPhenomenalDiff
{
	...
	const MidiTrackPatternPhenomenalDiff* midi_track_phenomenal_diff() const;
	const AudioTrackPatternPhenomenalDiff* audio_track_phenomenal_diff() const;
	MidiTrackPatternPhenomenalDiff* midi_track_phenomenal_diff();
	AudioTrackPatternPhenomenalDiff* audio_track_phenomenal_diff();
};
